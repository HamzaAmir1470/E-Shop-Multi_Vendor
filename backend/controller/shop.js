...
router.post("/create-shop", upload.single("file"), async (req, res, next) => {
    try {
        ...
        const seller = {
            ...
            avatar: {
                public_id: fileName,  // just use the filename as dummy ID
        ...
        try {
            ...
            try {
                await sendMail({
                    ...
                    message: `Hello ${seller.name},\n\nYour shop has been created successfully. You can now log in and start adding products.\n\nRegards,\nE-Shop Team`,
                });
            } catch (mailError) {
                console.error("Error sending shop creation email:", mailError);
            }
